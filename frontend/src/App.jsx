//React Router components allow us to create multiple pages without reloading the website.
...
//children means whatever is written between the opening and closing tags.
//protect private pages and check whether a user is allowed to open a page or not
const ProtectedRoute = ({ children, role }) => { //Props = Information passed to a component.
  const { user } = useAuth();
